/*
 * Scenario 14: Package Upgrade – Addi. License Downgrade – Seasonal License New Buy
*/
...
public class TestCase_14 extends BaseClass {
    ...
    public void initializePageObjects() {
        ...
        licenseCount = 6;                                     //Additional User Count

        upgradedLicenseCount = 5;                           //Additional User Count Now
    ...
    public void verifyCustomerPackageUpgradeAndLicensePurchase() throws InterruptedException {
        ...
        */
        ...
        /*
         * downgrading additional license and buy new seasonal license
         */
